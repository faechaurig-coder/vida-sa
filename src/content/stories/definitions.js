...
export const STORY_DEFS = {
  cantante: {
    ...
    arc: {
      ...
      adolescencia: { eventIds: ["c_ado_cantante_profesor"] },
    ...
    chapters: [
      ...
      { id: "talento_ado", label: "El profesor insiste", emoji: "🎹", order: 2 },
      { id: "juegos_uni", label: "Juegos universitarios", emoji: "🎤", order: 3 },
      { id: "productor", label: "Un productor te escucha", emoji: "🎧", order: 4 },
      { id: "primer_show", label: "Primer show pagado", emoji: "⭐", order: 5 },
      { id: "contrato", label: "Contrato profesional", emoji: "📝", order: 6 },
      { id: "fama", label: "Reconocimiento", emoji: "🏆", order: 7 },
    ],
  },
  futbolista: {
    id: "futbolista",
    ...
    arc: {
      ...
      universidad: { eventIds: ["c_uni_futbol_scouting"] },
    ...
    chapters: [
      ...
      { id: "scouting_uni", label: "Ojeador en las gradas", emoji: "👀", order: 3 },
      { id: "prueba", label: "Prueba semiprofesional", emoji: "⭐", order: 4 },
      { id: "contrato_pro", label: "Contrato profesional", emoji: "📝", order: 5 },
      { id: "fama", label: "El estadio te aplaude", emoji: "🏆", order: 6 },
    ],
  },
  escritor: {
    id: "escritor",
  ...
  actor: {
    ...
    hintFlags: ["actor_teatro", "actor_nino", "actor_casting", "actor_mentira"],
    arc: {
      infancia: { eventIds: ["c_inf_actor_obra"], flag: "actor_nino" },
      adolescencia: { eventIds: ["c_ado_actor_club"], flag: "actor_teatro" },
      universidad: { eventIds: ["c_uni_actor_obra"] },
    ...
    chapters: [
      { id: "teatro_infantil", label: "El árbol parlante", emoji: "🌳", order: 0 },
      { id: "teatro_escolar", label: "Teatro escolar", emoji: "🎭", order: 1 },
      { id: "obra_uni", label: "Improvisación", emoji: "🎬", order: 2 },
      { id: "casting", label: "El casting", emoji: "🎬", order: 3 },
      { id: "primer_rol", label: "Primer rol", emoji: "⭐", order: 4 },
      { id: "agente", label: "Un representante", emoji: "📋", order: 5 },
      { id: "fama", label: "Fama en pantalla", emoji: "🏆", order: 6 },
    ],
  },
  emprendedor: {
    id: "emprendedor",
    ...
    hintFlags: ["tiene_idea", "tiene_prototipo", "espiritu_emprendedor"],
    arc: {
      infancia: { eventIds: ["c_inf_limonada"], flag: "espiritu_emprendedor" },
    ...
    chapters: [
      { id: "limonada", label: "El puesto de limonada", emoji: "🍋", order: 0 },
      { id: "idea", label: "La idea", emoji: "💡", order: 1 },
      { id: "prototipo", label: "El prototipo", emoji: "🔧", order: 2 },
      { id: "primer_cliente", label: "Primer cliente", emoji: "💼", order: 3 },
      { id: "socio", label: "Un socio", emoji: "🤝", order: 4 },
      { id: "empresa", label: "Tu empresa", emoji: "🏆", order: 5 },
    ],
  },
};
